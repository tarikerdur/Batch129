...
public class Queue01 { // Queue (ENG) -- kuyruk, sira (TR)
    ...
    public static void main(String[] args) {
        ...
        myQueue.poll(); // --> [Milk]'i bize verir ve remove eder.

        //Retrieves and removes "the head of this queue".
        //This method differs from poll() only in that it THROWS an EXCEPTION if this queue is empty.
        //Returns:the head of this queue
        myQueue.remove(); // --> [Milk]'i bize verir ve remove eder.

        //Retrieves, but does not remove, "the head of this queue".
        //This method differs from peek only in that it THROWS an EXCEPTION if this queue is empty.
        myQueue.element(); // --> [Milk]'i bize verir ama remove etmez.

        //Retrieves, but does not remove, "the head of this queue", or returns null if this queue is empty.
        myQueue.peek(); // --> [Milk]'i bize verir ama remove etmez.
        ...
        // Java bir Logic kullanarak bunlari diziyor. Ama biz neye gore siralayacagini soyleyebiliriz. Bunu Lambda'da ogrenicez, dedi.
        // LinkedList'le PriorityQueue'nin farki budur.
        yourQueue.add("Milk");

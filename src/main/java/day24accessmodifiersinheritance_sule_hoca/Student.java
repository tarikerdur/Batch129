...
public class Student {
   ...
   Note: Class'lar icin hangi Access Modifier'lar kullanilabilir.
    ...
    // protected olanlar baska packagedan sadece child classlardan gorulur.
    protected String address = "Istanbul";

    // default olanlar farkli packagelardan gorulmez.
    String email = "abcan@gmail.com";

    // private olanlar sadece icinde bulunulan classtan gorulur

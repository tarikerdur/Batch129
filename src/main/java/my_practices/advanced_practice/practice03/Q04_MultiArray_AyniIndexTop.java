    ...
    */
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr1.length; i++) {
            ...
            if (limit > arr2[i].length) { // inner looptaki kosul yani "limit"i indexi kucuk olan array'e sabitlersek
                limit = arr2[i].length; // bu sayede indexi fazla olan arraylerin fazlalik indexlerini devre disi biraktik.
            }

...
public enum UsStates {
    ...
    3)  Sabit datalari app'in icine gommek icin enum kullaniriz. App'ler stand alone
    (kendi basina ayakta durabilmesi icin) olmasi gerektigi icin sabit datalari app'in icine gomeriz.
        */

...
//        Type code to print abbreviation (kisaltma) of the countries. "US, UK, DE, TR, IN, PE, ES, BG, AL, FR"
        ...
        System.out.println("Give us a country name that you want to abbreviation");
        String countryName = input.nextLine().replaceAll(" ", "").toLowerCase();
        ...
        switch (countryName) {
            ...
            case "france":
                ...
                break;
            default:
                System.out.println("This country that you give us is not recognized");
        }
